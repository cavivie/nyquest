...
use crate::bindings::android::net::http::{UploadDataProvider, UrlRequestCallback};
use crate::bindings::io::nyquest::httpengine::{
        ...
        self.vm
            .attach_current_thread(|env| -> jni::errors::Result<()> {
                ...
                if prepared.disable_cache {
                    builder.set_cache_disabled(env, JNI_TRUE)?;
                }
            ...
            .map_err(|error| jni_io("failed to start HttpEngine request", error))
    }
}
